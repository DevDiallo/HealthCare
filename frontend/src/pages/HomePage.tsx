...
const highlights = [
  {
    ...
    detail: 'Pilotage des admissions, rendez-vous et communications critiques en temps reel.',
  },
  {
    value: '6',
    label: 'Domaines orchestrés',
    detail: 'Patients, medecins, hopitaux, rendez-vous, auth et notifications centralises.',
  },
  {
    value: 'RBAC',
    label: 'Securite par role',
    detail: 'Acces controles pour super admin, etablissements, medecins et patients.',
  },
]
    ...
    <main className="landing-page">
      <section className="landing-hero">
        <div className="landing-copy">
          <span className="landing-kicker">Plateforme hospitaliere unifiee</span>
          <h1>Le cockpit operationnel pour piloter un reseau de soins moderne.</h1>
          <p className="landing-lead">
            HealthCare relie administration, parcours patient, rendez-vous et communications
            dans une experience professionnelle, securisee et exploitable a grande echelle.
          </p>
          <div className="landing-actions">
            <Link to="/login" className="landing-primary">Acceder a la plateforme</Link>
            <Link to="/register" className="landing-secondary">Creer un compte etablissement</Link>
          </div>
        ...
        <div className="landing-panel">
          <div className="landing-panel-card accent-card">
            ...
            <strong>Operations, soins et gouvernance dans le meme tableau de bord.</strong>
            <p>
              Priorisez les capacites, suivez les activites critiques et diffusez les
              informations utiles aux bonnes equipes.
            </p>
          </div>
      ...
      <section className="landing-section">
        <div className="landing-section-head">
          ...
          <h2>Une base serieuse pour operer, collaborer et monter en charge.</h2>
        </div>
      ...
      <section className="landing-section landing-split">
        <article className="landing-story-card">
          ...
          <p>
            La page d accueil n est plus un simple sas d authentification. Elle pose le cadre,
            met en avant les promesses du produit et donne une vision claire des usages couverts.
          </p>
        </article>
      ...
      <section className="landing-cta-band">
        <div>
          ...
          <h2>Connectez vos etablissements a une interface plus claire et plus credible.</h2>
        </div>
        <Link to="/login" className="landing-primary">Ouvrir la console</Link>
      </section>
    </main>
  )
}
